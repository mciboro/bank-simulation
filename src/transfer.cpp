...
Transfer::Transfer(Client& client, Client& recipient, Employee& banker, Desk& desk, double amount, unsigned id) : Service(client, banker, desk, amount, id), recipient(recipient) {};
...
unsigned Transfer::return_new_id()
{
    return numerator++;
}
